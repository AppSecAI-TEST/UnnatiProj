...
public class StudentList extends android.app.Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        HomePage.actionBar.setTitle("Student List");
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                if (direction == ItemTouchHelper.LEFT) {
                    if (ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                        ...
                        startActivity(new Intent(Intent.ACTION_CALL).setData(Uri.parse("tel:9762468325")));
                    }
                } else {
                    if (ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.SEND_SMS) != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(getActivity(), new String[]{Manifest.permission.SEND_SMS}, 1);
                    } else {
                        startActivity(new Intent(Intent.ACTION_VIEW).setData(Uri.parse("sms:9762468325")));
                    }
                }
